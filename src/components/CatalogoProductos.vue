        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col">
              ...
              <div class="text-primary" style="font-size: small;">{{ producto.Descrip2 }}</div>
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div v-if="tienepedido(producto.CodProd) > 0" style="text-align: right;" class="text-secondary-emphasis">
                    <i class="bi bi-cart-fill"></i> - {{ tienepedido(producto.CodProd) }}</div>
                </div>
              </div>
              <div class="row">
                <div class="col-6">
                ...
                <div class="col-6 " style="text-align: right;">
                  <h1 class="text-primary" @click="editarPedido(producto)" type="button" data-bs-toggle="modal"
                    data-bs-target="#ModalActivos"><i class="bi bi-eye-fill"></i></h1>
                </div>
              </div>
            </div>
          </div>
